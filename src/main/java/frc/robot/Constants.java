...
public final class Constants {
  ...
  public static final double MAX_VELOCITY_METERS_PER_SECOND =
      KRAKEN_X60_MAX_RPM / 60.0 * (14.0 / 50.0) * (27.0 / 17.0) * (15.0 / 45.0) * 0.10033 * Math.PI;

  public static final double DRIVETRAIN_RADIUS =
      Math.hypot(DRIVETRAIN_TRACKWIDTH_METERS / 2.0, DRIVETRAIN_WHEELBASE_METERS / 2.0);

  public static final double MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND =
      MAX_VELOCITY_METERS_PER_SECOND / DRIVETRAIN_RADIUS;

  public static final SwerveDriveKinematics DRIVE_KINEMATICS =
      new SwerveDriveKinematics(
          // Front left
          new Translation2d(
              DRIVETRAIN_TRACKWIDTH_METERS / 2.0, Constants.DRIVETRAIN_WHEELBASE_METERS / 2.0),
          // Front right
          new Translation2d(
              DRIVETRAIN_TRACKWIDTH_METERS / 2.0, -Constants.DRIVETRAIN_WHEELBASE_METERS / 2.0),
          // Back left
  ...
  // Step 1: Point all modules forward, with the bevel gear facing out, while either disabled or
  // turned off,
  // Note: Make sure the modules are aligned with each other using a straight object, like a 2 by 4,
  // or hex shaft,
  // Step 2: Open adventage scope, inside, open advantagekit and drive sections,
  // Step 3: Select the module you want to adjust, and pull the Turn Absolute Position into the line
  // graph,
  // Step 4: Pause the line graph and select a point to making viewing easier, then copy the Turn
  // Absolute Position,
  // Step 5: Add the copied position to the Steer Offset of the module (IN CODE), if there is
  // already a value add the 2 together,
  // Note: Repeat step 5 until the Turn Absolute Position is below 0.01,
  // Note: Make sure if the Turn Absolute Position is negative that the number added is also
  // negative,
  // Step 6: Test by driving forward, 2 of the complete modules should be running in the same
  // direction while aligned,
  // Note: If the modules are alined but one drives in the opposite direction,
  // flip the module going the wrong direction around, then repeat steps 1-6 for that module, bevel
  // gear out,
  ...
  public static final double TURN_MOTOR_CONVERSION_FACTOR =
      2 * Math.PI * (14.0 / 50.0) * (10.0 / 60.0);
  public static final double DRIVE_MOTOR_CONVERSION_FACTOR =
      (14.0 / 50.0)
          * (27.0 / 17.0)
          * (15.0 / 45.0)
          * 0.10033
  ...
  public static final double ELEVATOR_X_OFFSET =
      Units.inchesToMeters(-1); // positive further back negative
  // further
  // forward
